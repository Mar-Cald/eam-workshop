...
## Relative vs. Absolute {.small-text .align-center}

![](img/guide-eam.png){width="1000" height="400"}
...
dat = data.frame(rt = brms::rinv_gaussian(10000, mu = .3,shape = 1.3)+.2)
...
🧠 Effects on parameters were **consistent** across short/long RT tasks.
