...
Evidence Accumulation Models assume that, upon stimulus presentation (e.g., left- or right-facing arrow), the decision maker:
...
![](img/ramp.jpg){width="600" height=800"}

:::

::: {.column width="40%"}
![](img/ramp2.png){width="400" height=500"}

> [Zylberberg,& Shadlen, 2025](https://doi.org/10.1523/JNEUROSCI.4156-11.2012){target="_blank"}
...
[Wabersich and Vandekerckhove (2014), *The R Journal*](https://journal.r-project.org/archive/2014/RJ-2014-005/index.html){target="_blank"}
